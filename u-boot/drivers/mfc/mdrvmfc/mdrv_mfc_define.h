...
#define RemainCheck_Add1(wValue, ucMode)	((wValue%ucMode)?(wValue/ucMode+1):(wValue/ucMode))
#define PacketCountCheck(wValue, ucMode)	((wValue%ucMode)?(ucMode-wValue%ucMode):0)
//#define CalculateDecimal(dwX,dwY)         ((((U32)dwX) + (dwY / 2)) / dwY)
#define WidthCheck(wValue)	(TwoChip_Func?(wValue/2+GarBand):wValue)
...
#define PNL_LC550WUC_WUXGA_240HZ        0x28 //2Chip
...
////////////////////////////////////////////////////////////////////////////////////
//[7~4]:YUV/RGB,[3~0]:IpMode
#define IP_YC_8BIT				0x00
#define IP_YC_10BIT				0x01
#define IP_RGB_8BIT				0x12
#define IP_RGB_10BIT			0x13
#define IP_YC_10BIT_SPECIAL        0x04
#define IP_RGB_10BIT_SPECIAL    0x16
...
#define IP_MODE 					IP_YC_10BIT_SPECIAL//IP_YC_10BIT
#define MOD_POWER_ON_AFTER_INIT 	0 //Default output should be enable in boot part.(enable:0, disable:1)
...
#define ENABLE_Mst_func3_PWM_Freq   1
#define ENABLE_LVDSPHASE_AUTO 0
