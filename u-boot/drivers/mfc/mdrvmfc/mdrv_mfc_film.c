...
code MST_MFC_RegUnitType_t tInitializeMfc26_Common[]=
{
    ...
    #endif
    {0x2625, 0X80},
    {0x2626, 0x00}, //for bypasss window
    {0x2628, 0x40},
    {0x2629, 0x20}, //{0x2629, 0x12}, 
    {0x262A, 0X00},
	{0x262B, 0X00},
	{0x262C, 0X41},
	{0x262D, 0X81},
   ...
   /// {0x2661, 0X63}, //move to IpModeSel
	{0x2662, 0X1D},
	{0x2663, 0X9E},
	{0x2664, 0X01},
	{0x2665, 0X01},
   /// {0x2666, 0X70}, //move to IpModeSel
   /// {0x2667, 0X01}, //move to IpModeSel
	{0x2668, 0XBB},
	{0x2669, 0X26},
	{0x266A, 0X08},
	{0x266B, 0X87},
...
code MST_MFC_RegUnitType_t tInitializeMfc_Common[]=
{
	...
	{0x290C, 0X00},
	{0x290D, 0X00},
    {0x290E, REG_290E_DEFAULT},
	{0x290F, 0X1D},
    {0x2910, REG_2910_DEFAULT},
	{0x2911, 0X13},
    {0x2912, 0x10},
    {0x2913, 0x0C},
	{0x2914, 0X20},
    ...
    {0x294B, 0x60},
    {0x294C, 0x02},
    {0x294D, 0x01},//IChang--for words borken
    {0x294E, 0xB3},
    {0x294F, 0xFE},
    {0x2950, 0xFF},
    {0x2951, 0xFF},
...
void MDrv_MFC_InitializeMfc(void)
{
    ...
    if (gmfcSysInfo.u16Width == 1920 )
        MDrv_MFC_WriteByte(0x2952, 0x0F); //0x4F
    else // 1366, 1680
        MDrv_MFC_WriteByte(0x2952, 0x1F); //0x5F
