...
// Ryu_071126_1 : 시간 표시 방식 수정.
#define CHAR_KOREAN_YEAR    0xB144 //년
#define CHAR_KOREAN_MONTH   0xC6D4 //월
#define CHAR_KOREAN_DAY     0xC77C //일
...
#elif defined (__aeon__) || defined (__mips__)
...
#define B3_U32(u32)     ((U8)(u32>>24))
#define B2_U32(u32)     ((U8)(u32>>16))
#define B1_U32(u32)     ((U8)(u32>>8))
#define B0_U32(u32)     ((U8)(u32))

#define UNUSED(var)     (void)((var) = (var))

#define LOWBYTE(u16)    ((U8)(u16))
#define HIGHBYTE(u16)   ((U8)((u16) >> 8))
#define LOWORD(u32)     ((U16)(u32))
#define HIWORD(u32)     ((U16)((u32) >> 16))
