...
#define UTMI_WRREG8(reg_adr, data)					( (*( (volatile UINT8 *)  (HW_BASE+0x7400+reg_adr*2) ) ) = ((UINT8)data) )
#define UTMI_WRREG_ODD8(reg_adr, data)				( (*( (volatile UINT8 *)  (HW_BASE+0x7400+reg_adr*2-1) ) ) = ((UINT8)data) )
#define UTMI_RDREG8(reg_adr)						(*( (volatile UINT8 *)  (HW_BASE+0x7400+reg_adr*2) ) )
#define UTMI_RDREG_ODD8(reg_adr)					(*( (volatile UINT8 *)  (HW_BASE+0x7400+reg_adr*2-1) ) )
