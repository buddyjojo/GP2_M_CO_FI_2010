...
#define EMAC_ABSO_MEM_SIZE                  0x18000//0x20000//0x16000//0x180000//0x16000//(48 * 1024)     // More than: (32 + 16(0x3FFF)) KB
#define EMAC_MEM_SIZE_SQU                   4    // More than: (32 + 16(0x3FFF)) KB
//#define EMAC_BUFFER_MEM_SIZE                0x0004000
#define EMAC_MAX_TX_QUEUE                   30
// Base address here:
#if defined(CONFIG_TITANIA3_FPGA) ||defined (CONFIG_GP2_DEMO1) || defined(CONFIG_EUCLID)
...
//#define RX_BUFFER_SIZE					    (0x0008*RBQP_LENG)//(0x00004000<<RX_BUFFER_SEL)//0x10000//0x20000//

#ifdef SOFTWARE_DESCRIPTOR
#define RX_BUFFER_SEL                       0x0001          // 0x0=2KB,0x1=4KB,0x2=8KB,0x3=16KB, 0x09=1MB
#define RX_BUFFER_SIZE                      ((RBQP_LENG*0x600)<<RX_BUFFER_SEL)  //0x10000//0x20000//
#else
#define RX_BUFFER_SEL						0x0003			// 0x0=2KB,0x1=4KB,0x2=8KB,0x3=16KB, 0x09=1MB
#define RAM_REVERSE_SIZE					0x400//(0x00004000<<RX_BUFFER_SEL)//0x10000//0x20000//
#define RX_BUFFER_SIZE					    0x4000//(0x00004000<<RX_BUFFER_SEL)//0x10000//0x20000//
#endif


#define RBQP_LENG							0x10//0x0100  0x40//                // ==?descriptors
