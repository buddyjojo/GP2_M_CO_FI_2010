...
#endif
//dhjung LGE
#if defined(CONFIG_HARD_I2C) || defined(CONFIG_SOFT_I2C) || defined(CONFIG_TITANIA2) || defined(CONFIG_TITANIA3_FPGA) || defined(CONFIG_GP2_DEMO1) || defined(CONFIG_EUCLID)
#include <i2c.h>
#endif
...
{
//dhjung LGE
#if defined(CONFIG_TITANIA2) || defined(CONFIG_TITANIA3_FPGA) || defined(CONFIG_GP2_DEMO1) || defined(CONFIG_EUCLID)
	i2c_init ();
	//i2c_sw_init();//redcloud00@lge.com
#endif
	return 0;
}
