...
struct eth_device {
	...
	void (*halt) (struct eth_device*);
   	struct usb_device *udev; //20080605 Nick add
...
//2008/06/11 Nick Add start
extern int uEMAC_start; //2008/12/05 Nick
extern int uUSB_LAN_start;//2008/12/05 Nick
