...
#define CONFIG_TITANIA3_FPGA			1

#ifndef CPU_CLOCK_RATE
#define CPU_CLOCK_RATE					12000000			/* 200 MHz clock for the MIPS core */
#endif
...
#define CFG_KERLOAD_ADDR				0x80C00000			/* default kernel load address	*/
...
#define	CONFIG_EXTRA_ENV_SETTINGS												\
	"bootargs=root=/dev/mtdblock3 rootfstype=squashfs lpj=105984\0"				\
	"userpath=\0"																\
	"hostname=saturn7\0"											 			\
	"rootfs=flash\0"												 			\
	"autoboot=n\0"													 			\
...
#if 0
#define CONFIG_BOOTCOMMAND				"dplogo; xip lgapp; xip lgfont; cp2ram kernel 0x80C00000; bootm 0x80C00000"
#else
#define CONFIG_BOOTCOMMAND				"xip lgapp; xip lgfont; cp2ram kernel 0x80C00000; bootm 0x80C00000"
#endif
#define CONFIG_COMMANDS					((CFG_CMD_PING   | CFG_CMD_NET   | CFG_CMD_USB  | CFG_CMD_NAND | 	\
										  CFG_CMD_MEMORY | CFG_CMD_RUN   | CFG_CMD_ENV  | CFG_CMD_CACHE) &	\
...
/* Cache configuration
 */
#define CFG_DCACHE_SIZE					4*1024
#define CFG_ICACHE_SIZE					4*1024
