...
void MDrv_MFC_InitializeScTop(void)
{
	...
	if(gmfcSysInfo.u8PanelType == _MINI_LVDS_GIP || gmfcSysInfo.u8PanelType == _MINI_LVDS_GIP_V5 )//(MDrv_MFC_ReadByte(0x1E48) == 3) // GIP 37"if(MDrv_MFC_ReadByte(0x1E48) == 3) // GIP 37"
    {
       MDrv_MFC_WriteRegsTbl(0x3200, tIniTconCommPreEmphasis);
       MDrv_MFC_WriteByte(0x3250, 0x48);
