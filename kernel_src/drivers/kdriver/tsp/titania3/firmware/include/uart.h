...
//wait both Transmitter empty / Transmit-hold-register empty ============================
#define WAIT_FOR_XMITR                                              \
        do {                                                        \
                lsr = UART_REG8(UART_BASE + UART_LSR);              \
        } while ((lsr & BOTH_EMPTY) != BOTH_EMPTY)

//wait Transmit-hold-register empty =====================================================
...
//Receiver data ready ===================================================================
#define CHECK_FOR_CHAR (UART_REG8(UART_BASE + UART_LSR) & UART_LSR_DR)
