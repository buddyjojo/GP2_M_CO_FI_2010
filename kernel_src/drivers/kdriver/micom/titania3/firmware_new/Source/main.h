...
// taburin : to convert input data to lower case, because ack(data) should be lower case
#define CONVERT_LOWERCASE

#ifdef ENABLE_NEW_AC_DET

#if (MS_BOARD_TYPE_SEL == BD_S6_ATSC_GP)
#define START_POLL_AC_DET_WAIT_TIME 4000//400 //ms
#else
#define START_POLL_AC_DET_WAIT_TIME 1000//100 //ms
#endif
...
typedef enum
{
    ...
    MICOM_VERSION_BYTE2 = 2,
//.
    MICOM_VERSION_BYTE3 = 2,
    MICOM_VERSION_BYTE4 = 4
...
#if (MS_BOARD_TYPE_SEL != BD_S6_PDP)	//LCD model 8 key	
...
#else	//PDP only	//PDP model 7 key
/*==================Key 1=============*/
#define NOT_USED_UPBOUND            0x34 //0x2B//0x39 //0x38
#define NOT_USED_LOBOUND            0x25 //0x29//0x36 //0x37
#define SW3_CH_MINUS_UPBOUND        0x24 //0x19//0x2D //0x2C
#define SW3_CH_MINUS_LOBOUND        0x15 //0x17//0x2A //0x2B
#define SW2_INPUT_UPBOUND           0x14 //0x0E//0x18 //0x17
#define SW2_INPUT_LOBOUND           0x07 //0x0C//0x15 //0x16
#define SW1_CH_PLUS_UPBOUND         0x06 //0x03//0x05 //0x04
#define SW1_CH_PLUS_LOBOUND         0x01 //0x01//0x02 //0x03
/*==================Key 2=============*/
#define SW7_OK_UPBOUND              0x34 //0x2B//0x39 //0x38
#define SW7_OK_LOBOUND              0x25 //0x29//0x36 //0x37
#define SW6_MENU_UPBOUND            0x24 //0x19//0x2D //0x2C
#define SW6_MENU_LOBOUND            0x15 //0x17//0x2A //0x2B
#define SW5_VOL_PLUS_UPBOUND        0x14 //0x0E//0x19 //0x18
#define SW5_VOL_PLUS_LOBOUND        0x07 //0x0C//0x15 //0x16
#define SW4_VOL_MINUS_UPBOUND       0x06 //0x05 //0x04
#define SW4_VOL_MINUS_LOBOUND       0x01 //0x02 //0x03
#endif
...
#define ACK_TYPE_NEK 0
#define ACK_TYPE_STATUS 2
