...
/* PQ Board 전에 임시 사용 - ATSC VENUS */
//#define DIFFEENCE_VENUS_FROM_MINERVA_ATSC
...
// for PDP
#define LED_W1_INPUT()		GPIO_PM0_INPUT()
#define LED_W1_OUTPUT()   	GPIO_PM0_OUTPUT()
#define LED_W1_HIGH() 		GPIO_PM0_SET(1)
#define LED_W1_LOW() 		GPIO_PM0_SET(0)
// for ATSC S5
#define RL_ON()			GPIO_PM0_OUTPUT_LOW()
#define RL_OFF()			GPIO_PM0_OUTPUT_HIGH()
...
//5V_ON for PDP
#define ON5V_DISABLE()    GPIO_PM2_INPUT()

#define ON5V_ENABLE()     GPIO_PM2_OUTPUT()
#define ON5V_ON()    	GPIO_PM2_OUTPUT_HIGH()
#define ON5V_OFF()    	GPIO_PM2_OUTPUT_LOW()

#define ON5V_HIGH()	   	GPIO_PM2_OUTPUT_HIGH()
#define ON5V_LOW()    	GPIO_PM2_OUTPUT_LOW()
...
//DISP_EN for PDP
#define MNT_5V_DISABLE()   	GPIO_PM3_OUTPUT()
#define MNT_5V_ENABLE()    	GPIO_PM3_INPUT()
#define MNT_5V_HIGH()  		GPIO_PM3_HIGH()
#define MNT_5V_LOW()    	GPIO_PM3_LOW()
...
#ifdef DIFFEENCE_VENUS_FROM_MINERVA_ATSC
...
//LED_W1 for PDP
#define LED_W2_INPUT()		GPIO_SAR2_INPUT()
#define LED_W2_OUTPUT()   	GPIO_SAR2_OUTPUT()
#define LED_W2_HIGH() 		GPIO_SAR2_SET(1)
#define LED_W2_LOW() 		GPIO_SAR2_SET(0)
...
#define SB_MUTE_INPUT()    GPIO_SAR3_INPUT()
#define SB_MUTE_OUTPUT()    GPIO_SAR3_OUTPUT()
