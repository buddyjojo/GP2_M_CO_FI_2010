...
#define BD_S6_VENUS             0x0082
#define BD_S5_MINERVA       	0x0083
#define BD_S5_MERCURY       	0x0084
...
#define MS_BOARD_TYPE_SEL   BD_S6_VENUS
//#define MS_BOARD_TYPE_SEL	BD_S5_MINERVA
//#define MS_BOARD_TYPE_SEL	BD_S5_MERCURY
//#define MS_BOARD_TYPE_SEL BD_S6_PDP
//----------------------------- Board Link -------------------------------------
#if (MS_BOARD_TYPE_SEL == BD_S6_VENUS )
    #include "BD_S6_VENUS.h"
#elif (MS_BOARD_TYPE_SEL == BD_S5_MINERVA )
    #include "BD_S5_MINERVA.h"
#elif (MS_BOARD_TYPE_SEL == BD_S5_MERCURY )
    #include "BD_S5_MERCURY.h"	
