...
typedef struct
{
    ...
    xvid_image_t xvid_current;   /* [out] -> [in,out] */
...
typedef struct
{
    ...
    int target_framesize32;
    int sequence_quality32;
    int avg_framesize32;
    int quant_error32[31];
#elif (_FIXEDPTR_ ==2)
    INT64 time64;
    INT64 reaction_delay_factor64;
    INT64 target_framesize64;
    INT64 sequence_quality64;
    INT64 avg_framesize64;
    INT64 quant_error64[31];
#elif (_FIXEDPTR_ ==0)
