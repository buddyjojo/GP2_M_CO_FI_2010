...
/////////////////////////////////////////////////////////////////////////////////////////////
#ifndef _MHAL_CC_TYPES_H
#define _MHAL_CC_TYPES_H
///////////////////////////////////////////////////////////////////////////////
/// @file   mhal_cc_types.h
/// This file contains the Mstar driver types for Close Caption
...
#if 1
#define CC_KDBG(x1, args...)            printk(KERN_WARNING x1, ## args)
#endif
...
typedef enum
{
    E_VIDEOSTANDARD_PAL_BGHI        = 0x00,        ///< Video standard PAL BGHI; PAL
    E_VIDEOSTANDARD_NTSC_M          = 0x01,        ///< Video standard NTSC M; NTSC
    E_VIDEOSTANDARD_SECAM           = 0x02,        ///< Video standard SECAM; N
    E_VIDEOSTANDARD_NTSC_44         = 0x03,        ///< Video standard  NTSC 44; N
    E_VIDEOSTANDARD_PAL_M           = 0x04,        ///< Video standard  PAL M; PAL M
    E_VIDEOSTANDARD_PAL_N           = 0x05,        ///< Video standard  PAL N; PAL Nc
    E_VIDEOSTANDARD_PAL_60          = 0x06,        ///< Video standard PAL 60; NTSC443
