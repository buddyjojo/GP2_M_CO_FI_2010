...
#ifndef _MDRV_MICOM_ST_H_
#define _MDRV_MICOM_ST_H_
...
typedef struct
{
    ...
    U8 u8PmWakeIR[PM_MAX_BUF_WAKE_IR];
    //TBD: need to think about other wakeup sources
    PM_Result   Result;
} PM_WakeCfg_t;

typedef struct
{
    U8 u8PmLibVer[VERSION_STRING_MAX];
