...
typedef struct MST_PANEL_INFO_s
{
    ...
    U16 u16MOD_CTRLA;
    U8  u8MOD_CTRLB;
    U8  u8MOD_CTRL2;    // 20100113 daniel.huang: For URSA3 U02, we need to switch to LVDS. And after URSA3 U02, we can set to TTL.

	U8  u8MOD_CTRL77;	//pre-emphasis level
	U8  u8MOD_CTRL78;   // [7]: reg_pdn_regu [6]: reggcr_outswing2x [3:1] reg_gcr_outswing [0]: reg_pd_mod
