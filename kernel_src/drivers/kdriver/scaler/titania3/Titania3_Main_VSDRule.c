...
code U8 MST_VSDRule_Array_Main[PQ_VSDRule_NUM_Main][PQ_VSDRule_IP_NUM_Main]=
{
    {//PreV_ScalingDown_Interlace, 0
        PQ_IP_VSD_Bilinear_Main, PQ_IP_VSP_PreVBound_ON_Main, PQ_IP_VCLPF_ON_Main, PQ_IP_DMS_V_12L_OFF_Main, 
    },
    {//PreV_ScalingDown_Progressive, 1
        PQ_IP_VSD_CB_Main, PQ_IP_VSP_PreVBound_ON_Main, PQ_IP_VCLPF_ON_Main, PQ_IP_DMS_V_12L_OFF_Main, 
    },
