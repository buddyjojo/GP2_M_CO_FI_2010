...
#ifndef _MHAL_QMAP_H_
#define _MHAL_QMAP_H_
...
#include "Titania3_Main.h"              // table config parameter
#include "Titania3_Main_HSDRule.h"      // table config parameter
#include "Titania3_Main_VSDRule.h"      // table config parameter
#include "Titania3_Main_HSPRule.h"      // table config parameter
#include "Titania3_Main_VSPRule.h"      // table config parameter
#include "Titania3_Main_CSCRule.h"      // table config parameter
