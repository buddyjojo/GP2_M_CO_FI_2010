...
//-------------------------------------------------------------------------------------------------
void MHal_EMAC_write_phy( unsigned char phy_addr,
                          ...
                          u32 value )
{
    ...
    uRegVal = ( ( EMAC_HIGH |
                  EMAC_CODE_802_3 |
                  EMAC_RW_W |
                  ( ( phy_addr & 0x1F ) << PHY_ADDR_OFFSET ) |
                  ( address << PHY_REGADDR_OFFSET ) ) ) |
              ( value & 0xFFFF );
...
// Note: MDI interface is assumed to already have been enabled.
//-------------------------------------------------------------------------------------------------
void MHal_EMAC_read_phy( unsigned char phy_addr,
                         unsigned char address,
                         u32* value )
{
    u32 uRegVal;
...
{
    u8 hashIdx0 = ( m0&0x01 ) ^ ( ( m0&0x40 ) >> 6 ) ^ ( ( m1&0x10 ) >> 4 ) ^ ( ( m2&0x04 ) >>
                                                                                2 ) ^ ( m3&0x01 ) ^ ( ( m3&0x40 ) >>
                                                                                                      6 ) ^ ( ( m4&0x10 ) >>
                                                                                                              4 ) ^ ( ( m5&0x04 ) >>
                                                                                                                      2 );
    u8 hashIdx1 = ( m0&0x02 ) ^ ( ( m0&0x80 ) >> 6 ) ^ ( ( m1&0x20 ) >> 4 ) ^ ( ( m2&0x08 ) >>
                                                                                2 ) ^ ( m3&0x02 ) ^ ( ( m3&0x80 ) >>
                                                                                                      6 ) ^ ( ( m4&0x20 ) >>
                                                                                                              4 ) ^ ( ( m5&0x08 ) >>
                                                                                                                      2 );
    u8 hashIdx2 = ( m0&0x04 ) ^ ( ( m1&0x01 ) << 2 ) ^ ( ( m1&0x40 ) >> 4 ) ^ ( ( m2&0x10 ) >>
                                                                                2 ) ^ ( m3&0x04 ) ^ ( ( m4&0x01 ) <<
                                                                                                      2 ) ^ ( ( m4&0x40 ) >>
                                                                                                              4 ) ^ ( ( m5&0x10 ) >>
                                                                                                                      2 );
    u8 hashIdx3 = ( m0&0x08 ) ^ ( ( m1&0x02 ) << 2 ) ^ ( ( m1&0x80 ) >> 4 ) ^ ( ( m2&0x20 ) >>
                                                                                2 ) ^ ( m3&0x08 ) ^ ( ( m4&0x02 ) <<
                                                                                                      2 ) ^ ( ( m4&0x80 ) >>
                                                                                                              4 ) ^ ( ( m5&0x20 ) >>
                                                                                                                      2 );
    u8 hashIdx4 = ( m0&0x10 ) ^ ( ( m1&0x04 ) << 2 ) ^ ( ( m2&0x01 ) << 4 ) ^ ( ( m2&0x40 ) >>
                                                                                2 ) ^ ( m3&0x10 ) ^ ( ( m4&0x04 ) <<
                                                                                                      2 ) ^ ( ( m5&0x01 ) <<
                                                                                                              4 ) ^ ( ( m5&0x40 ) >>
                                                                                                                      2 );
    u8 hashIdx5 = ( m0&0x20 ) ^ ( ( m1&0x08 ) << 2 ) ^ ( ( m2&0x02 ) << 4 ) ^ ( ( m2&0x80 ) >>
                                                                                2 ) ^ ( m3&0x20 ) ^ ( ( m4&0x08 ) <<
                                                                                                      2 ) ^ ( ( m5&0x02 ) <<
                                                                                                              4 ) ^ ( ( m5&0x80 ) >>
                                                                                                                      2 );
...
u32 MHal_EMAC_NegotiationPHY( void )
{
    ...
    //Fix RTK
    MHal_EMAC_read_phy(phyaddr, 2, &retValue);
    if (RTK_OUI_MSB == retValue)
    {
        printk("Force change RTK PHY RTL8201E Reg 25 to RMII mode:");
        MHal_EMAC_read_phy(phyaddr, 25, &retValue);
        printk("%x -> ", retValue);
...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    *( ( u32 * ) ( ( char * ) 0xBF201600 +  0x61*4) ) = 0x0004;
    ...
    //chiptop clk
    *( ( u32 * ) ( ( char * ) 0xbf203c14 ) ) = 0;
    *( ( u32 * ) ( ( char * ) 0xbf203c18 ) ) = 0x0800;  //reg_package =2
    *( ( u32 * ) ( ( char * ) 0xbf203c54 ) ) = 0;
    *( ( u32 * ) ( ( char * ) 0xbf203c1c ) ) = 0;
}
