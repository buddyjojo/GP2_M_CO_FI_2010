...
#define RX_BUFFER_SIZE                      (0x00002000<<RX_BUFFER_SEL)//0x10000//0x20000//
...
#define JULIAN_100_VAL                      (0x0000F007)
...
#elif defined(PHY_8720)
#define PHY_ADDR                            (0x0F)
#endif
