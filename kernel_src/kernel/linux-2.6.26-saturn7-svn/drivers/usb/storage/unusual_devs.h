...
/*Colin, 090319, for unplug HD while playing movie and then plug, the device returns wrong MAX LUN */
UNUSUAL_DEV(  0x13fd, 0x1650, 0x0000, 0x9999,
		"Initio",
		"WD2500BEVS-00UST",
		US_SC_SCSI, US_PR_BULK, NULL,
		US_FL_SINGLE_LUN ),

/*Colin, 090917, for mini-SD Card Reader, wrong residual*/
...
/*Colin, 100128, for aigo pen drive, wrong residual*/
UNUSUAL_DEV(  0x0ed1, 0x6981, 0x0000, 0x9999,
		"aigo",
		"Miniking Device",
		US_SC_SCSI, US_PR_BULK, NULL,
		US_FL_IGNORE_RESIDUE ),
