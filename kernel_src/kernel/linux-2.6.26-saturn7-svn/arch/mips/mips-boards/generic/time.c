...
static unsigned int __init estimate_cpu_frequency(void)
{
	...
	if ( *((unsigned int*)0xbf803c6c) & 0x0020)
	{
		if( (*((unsigned int*)0xbf803c6c) & 0x001C) == 0x0000)
			count = 216000000 >> 1;
		else if( (*((unsigned int*)0xbf803c6c) & 0x001C) == 0x001C)
			count = 200000000 >> 1;
		else if( (*((unsigned int*)0xbf803c6c) & 0x001C) == 0x0008)
			count = 170000000 >> 1;
		else if( (*((unsigned int*)0xbf803c6c) & 0x001C) == 0x000C)
			count = 160000000 >> 1;
		else if( (*((unsigned int*)0xbf803c6c) & 0x001C) == 0x0010)
			count = 144000000 >> 1;
		else if( (*((unsigned int*)0xbf803c6c) & 0x001C) == 0x0014)
			count = 123000000 >> 1;
		else if( (*((unsigned int*)0xbf803c6c) & 0x001C) == 0x0018)
			count = 108000000 >> 1;
		else
		{
			count = 123000000 >> 1;
    ...
    count = count >> 1;
    #else
    count = 12000000>>1 ; //count = 216000000 >> 1;
	#endif
