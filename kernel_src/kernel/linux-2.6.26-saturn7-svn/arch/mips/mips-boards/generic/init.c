...
static void __init mips_nmi_setup(void)
{
	...
	base = cpu_has_veic ?
		(void *)(CAC_BASE + EBASE_OFFSET + 0xa80) :
		(void *)(CAC_BASE + EBASE_OFFSET + 0x380);
...
static void __init mips_ejtag_setup(void)
{
	...
	base = cpu_has_veic ?
		(void *)(CAC_BASE + EBASE_OFFSET + 0xa00) :
		(void *)(CAC_BASE + EBASE_OFFSET + 0x300);
...
mips_pci_controller:
	...
	//dhjung LGE : pr_info -> printk
	printk(KERN_DEBUG "LINUX started...\n");
	prom_init_cmdline();
	prom_meminit();
#ifdef CONFIG_SERIAL_8250_CONSOLE
	console_config();
