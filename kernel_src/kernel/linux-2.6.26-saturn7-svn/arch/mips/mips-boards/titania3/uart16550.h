...
#define UART0_REG8(addr)            *((volatile unsigned int*)(REG_UART0_BASE + ((addr)<< 3)))
#define UART1_REG8(addr)            *((volatile unsigned int*)(REG_UART1_BASE + ((addr)<< 3)))
#define UART2_REG8(addr)            *((volatile unsigned int*)(REG_UART2_BASE + ((addr)<< 3)))
#endif
...
#define UART_LCR                    3   // 2           // Line Control Register
#define UART_LSR                    5  //  3           // Line Status Register
...
#define UART_DL2_MSB                0           // Divisor Latch High
#define UART_FIFO                   1           // Divisor Latch Low
#define UART_IER                    2  //  1           // Interrupt Enable Register
#define UART_FCR                    4  //  2           // FIFO Control Register
#define UART_LCR                    6  //  3           // Line Control Register
#define UART_MCR                    8
#define UART_LSR                    5  //  3           // Line Status Register
#define UART_RB                     3           // optional: set rf_pop delay for memack ; [3:0] rf_pop_delay; [6] rf_pop_mode_sel ; [7] reg_rb_read_ack
#endif
...
#define UART_CLK_FREQ               12000000 //160000000 //144000000 //12000000 //123000000    //14318180    //43200000 //14318180
#elif defined(CONFIG_MSTAR_TITANIA_BD_GP2_DEMO1)
#define UART_BAUD_RATE	            115200 //9600 //19200 //38400 //57600 //115200 =>too frequent Rx INT
#define UART_CLK_FREQ               123000000 //160000000 //144000000 //12000000 //123000000    //14318180    //43200000 //14318180
#else
#define UART_BAUD_RATE	            115200 //9600 //19200 //38400 //57600 //115200 =>too frequent Rx INT
#define UART_CLK_FREQ               172800000 //160000000 //144000000 //12000000 //123000000    //14318180    //43200000 //14318180
#endif
...
#else
#define UART_DIVISOR				(UART_CLK_FREQ/(16 * baudrate))
#endif
