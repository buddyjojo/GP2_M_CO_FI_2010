...
#define MIU0_MEM_BASE_LEN           0x10000000
...
#define SCALER_DNR_BUF_LEN	  		((0x1000000-80) + (8*0x100000)) //16MB-80byte + 8M //0xC00000  //12582912	// 12MB
...
#define VE_FRAMEBUFFER_LEN			(0x32A000UL + 0x2800) 	// 720*576*2*4 + 10KByte(ttx insertion)
...
#define MPOOL_LEN				    (28*0x100000) //(28*0x100000) - remove back buffer of directFB
...
#define MIU1_MEM_BASE_LEN           0x10000000
...
#if JPEG_HW_PATCH
#define JPD_OUTPUT_LEN           	0x400000 //  for Jpeg HW patch , 2M + 10M (patch)
#else
...
#define MIU1_POOL_LEN           	(16*0x100000)

#define OD_MSB_BUFFER_AVAILABLE		(MIU1_POOL_ADR+MIU1_POOL_LEN)
#define OD_MSB_BUFFER_ADR			MemAlign(OD_MSB_BUFFER_AVAILABLE, 8)
#define OD_MSB_BUFFER_ADR_GAP_CHK	(OD_MSB_BUFFER_ADR-OD_MSB_BUFFER_AVAILABLE)
#define OD_MSB_BUFFER_LEN			(4*0x100000)

#define OD_LSB_BUFFER_AVAILABLE		(OD_MSB_BUFFER_ADR+OD_MSB_BUFFER_LEN)
#define OD_LSB_BUFFER_ADR			MemAlign(OD_LSB_BUFFER_AVAILABLE, 8)
#define OD_LSB_BUFFER_ADR_GAP_CHK	(OD_LSB_BUFFER_ADR-OD_LSB_BUFFER_AVAILABLE)
#define OD_LSB_BUFFER_LEN			(2*0x100000)

#define BB_AVAILABLE                (OD_LSB_BUFFER_ADR+OD_LSB_BUFFER_LEN)
