...
#if CONFIG_MSTAR_TITANIA_BD_S5_LG_DEMO_BOARD_1 || CONFIG_MSTAR_TITANIA_BD_S6_LG_DEMO_BOARD_ATSC_1
...
#define MVD_FRAMEBUFFER_LEN          0xC00000	//0xE00000 // 14MB //0x1DB000 // 1900KB, 3 Buffers=720*576*1.5*3
...
#define MVD_BITSTREAM_LEN           0x200000	//2MB //0x80000                     // 512KB
...
#define LINUX_2ND_MEM_AVAILABLE		(TTX_BUF_ADR/*USB_MEM_ADR*/ + TTX_BUF_LEN/*USB_MEM_LEN*/)
...
#define LINUX_2ND_MEM_LEN			0x200000//0x182FB0

#define USB_DMA_ADDRESS 	LINUX_2ND_MEM_ADR 
#define USB_DMA_LENGTH		LINUX_2ND_MEM_LEN
