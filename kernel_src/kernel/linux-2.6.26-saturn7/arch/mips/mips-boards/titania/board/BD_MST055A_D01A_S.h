...
#ifndef _BD_MST055A_D01A_S_H
#define _BD_MST055A_D01A_S_H

#define BOARD_NAME                  "BD_MST055A_D01A_S"
...
// Audio Amplifier
#define Audio_Amplifier_ON()        MDrv_GPIO_Set_High(93);MDrv_GPIO_Set_Low(94)
#define Audio_Amplifier_OFF()       MDrv_GPIO_Set_High(93);MDrv_GPIO_Set_High(94)

//------Chip Type---------------------------------------------------------------
#include "chip/msd3102eq.h"

//------MIU setting ----------------------------------------------------------------
#define MIU_0_02                        0x0345
