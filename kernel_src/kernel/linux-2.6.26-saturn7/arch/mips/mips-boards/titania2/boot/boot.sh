...
if [ "$IN_LINUX_ENV" == "Linux" ] ; then
    ../../../../../../../RedLion_Tools/boot_utils/linux_lzma e out/uranus.bin out/uranus.zip -lc0 -lp2  # SUPPORT_UNZIP
else
    ../../../../../../../RedLion_Tools/boot_utils/lzma.exe e out/uranus.bin out/uranus.zip -lc0 -lp2  # SUPPORT_UNZIP
fi
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_MST055A_D01A_S=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 1\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055E_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST056C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_S5_LG_DEMO_BOARD_1 = 0\n" >> $BOOT1_INC
    printf "BD_S6_LG_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_VENUS_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MINERVA_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_VENUS_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
fi

test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_MST055B_D01A_S=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 1\n" >> $BOOT1_INC
    printf "BD_MST055C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055E_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST056C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_S5_LG_DEMO_BOARD_1 = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_MST055C_D01A_S=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055C_D01A_S = 1\n" >> $BOOT1_INC
    printf "BD_MST055E_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST056C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_S5_LG_DEMO_BOARD_1 = 0\n" >> $BOOT1_INC
    printf "BD_S6_LG_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_MST055E_D01A_S=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055E_D01A_S = 1\n" >> $BOOT1_INC
    printf "BD_MST056C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_S5_LG_DEMO_BOARD_1 = 0\n" >> $BOOT1_INC
    printf "BD_S6_LG_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
	printf "BD_T2_LG_VENUS_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_MST056C_D01A_S=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_S5_LG_DEMO_BOARD_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_MST055E_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST056C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_S5_LG_DEMO_BOARD_1 = 1\n" >> $BOOT1_INC
    printf "BD_S6_LG_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
	printf "BD_T2_LG_VENUS_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
	printf "BD_T2_LG_MECURY_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_S6_LG_DEMO_BOARD_ATSC_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_MST056C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_S5_LG_DEMO_BOARD_1 = 0\n" >> $BOOT1_INC
    printf "BD_S6_LG_DEMO_BOARD_ATSC_1 = 1\n" >> $BOOT1_INC
	printf "BD_T2_LG_VENUS_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
	printf "BD_T2_LG_MECURY_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MINERVA_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_T2_LG_VENUS_BOARD_DVB_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_S5_LG_DEMO_BOARD_1 = 0\n" >> $BOOT1_INC
    printf "BD_S6_LG_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
	printf "BD_T2_LG_VENUS_BOARD_DVB_1 = 1\n" >> $BOOT1_INC
	printf "BD_T2_LG_MECURY_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MINERVA_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_VENUS_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_T2_LG_MECURY_BOARD_ATSC_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_S6_LG_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_VENUS_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_ATSC_1 = 1\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MINERVA_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_VENUS_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_T2_LG_MECURY_BOARD_DVB_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_T2_LG_VENUS_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_DVB_1 = 1\n" >> $BOOT1_INC
    printf "BD_T2_LG_MINERVA_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_VENUS_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
fi

test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_T2_LG_MINERVA_BOARD_ATSC_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_T2_LG_MECURY_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MECURY_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MINERVA_BOARD_ATSC_1 = 1\n" >> $BOOT1_INC
    printf "BD_T2_LG_VENUS_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
fi

test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_T2_LG_VENUS_BOARD_ATSC_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_T2_LG_MECURY_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_MINERVA_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_LG_VENUS_BOARD_ATSC_1 = 1\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
fi
