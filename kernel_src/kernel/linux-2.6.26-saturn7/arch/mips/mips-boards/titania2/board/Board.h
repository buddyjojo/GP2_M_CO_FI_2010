...
#define BD_T2_LG_VENUS_BOARD_ATSC_1 0x46

// 0x60 ~ 0x6F PDP Customers' board
#define BD_T2_LG_PDP_BOARD_DVB_1	0x60
...
#elif defined (CONFIG_MSTAR_TITANIA_BD_T2_LG_PDP_BOARD_DVB_1)
    #define MS_BOARD_TYPE_SEL       BD_T2_LG_PDP_BOARD_DVB_1
#elif defined (CONFIG_MSTAR_TITANIA_BD_T2_LG_VENUS_BOARD_ATSC_1)
    #define MS_BOARD_TYPE_SEL       BD_T2_LG_VENUS_BOARD_ATSC_1
#else
...
#elif (MS_BOARD_TYPE_SEL == BD_T2_LG_PDP_BOARD_DVB_1)
    #include "BD_T2_LG_PDP_BOARD_DVB_1.h"
#elif (MS_BOARD_TYPE_SEL == BD_T2_LG_VENUS_BOARD_ATSC_1)
    #include "BD_T2_LG_VENUS_BOARD_ATSC_1.h"
#else
