...
#ifndef _BD_T2_LG_VENUS_BOARD_ATSC_1_H
#define _BD_T2_LG_VENUS_BOARD_ATSC_1_H

#define BOARD_NAME                  "BD_T2_LG_VENUS_BOARD_ATSC_1"
...
#define IR_TYPE_SEL						IR_TYPE_CUS03_DTV // IR_TYPE_MSTAR_DTV
...
/*	BOOTSTRAP GPIO (DISPLAY TYPE/MODULE TYPE)	*/
#define BALL_D6_IS_GPIO             GPIO_IN         // (GPIO#99)                  GPIO99
#define	BALL_D7_IS_GPIO             GPIO_IN         // MEMC_RESET(GPIO#90)        GPIO90/I2S_OUT_MUTE
#define	BALL_E11_IS_GPIO            GPIO_IN         // FE_AGC_SPEED_CTL(GPIO#91)  GPIO91
#define	BALL_B9_IS_GPIO             GPIO_IN         // /FE_RESET(GPIO#105)        ET_MDIO

/* SC_RE1, SC_RE2 */
#define BALL_A9_IS_GPIO             GPIO_OUT_HIGH   // SC_RE1  High:  Off
#define BALL_B11_IS_GPIO            GPIO_OUT_HIGH   // SC_RE2  High:  Off

/* USB_CTL : set LOW to usb power off               (dreamer@lge.com)	*/
#define	BALL_A7_IS_GPIO             GPIO_OUT_LOW    // USB_CTL Low:  Off

/* PDP(STANDBY LED)/LCD(FE_ANT5V_CTL)	: set LOW   (dreamer@lge.com)	*/
#define	BALL_C8_IS_GPIO             GPIO_OUT_LOW    // LED_R/FE_ANT5V_CTL Low:  Off
...
#define LGE_DEMO_BOARD
#if 0
#define HeadPhone_ON()                      MDrv_GPIO_Set_High(96)
#define HeadPhone_OFF()                     MDrv_GPIO_Set_Low(96)
#define LG_AMP_MUTE_ON()                MDrv_GPIO_Set_High(90)
#define LG_AMP_MUTE_OFF()               MDrv_GPIO_Set_Low(90)
#endif
//============================================
...
#define AUDIO_PATH_MAIN_SPEAKER     AUDIO_PATH_I2S
...
#define MIU_0_36                        0x8245	// samuel 0x0245 -> 0x8245
#define MIU_0_38                        0x0050

//	MIU1: change 128MB to 64MB			(dreamer@lge.com)
#if 1
#define MIU_1_02                        0x0C45  // length 128MB
#else
#define MIU_1_02                        0x0545  // length  64MB
#endif
#define MIU_1_36                        0x8245 	// samuel : 0x0244 -> 0x0245 -> 0x8245
#define MIU_1_38                        0x0040
...
#if 1 // drmyung 080812 : need to move LGSW
//------ SCALER INPUT SOURCE MUX ---------------------------------------------------
#define SC_VGA_AMUX         0x1
#define SC_YPBPR1_AMUX      0x1//0x2
#define SC_YPBPR2_AMUX      0x1//0x1F

#define SC_ATV_YMUX         0x0
#define SC_ATV_CMUX         0x1F

// T2 CVBS change ip mux
#define SC_CVBS1_YMUX       0x3//0x1
#define SC_CVBS1_CMUX       0x1F
#define SC_CVBS2_YMUX       0x1//0x1F
