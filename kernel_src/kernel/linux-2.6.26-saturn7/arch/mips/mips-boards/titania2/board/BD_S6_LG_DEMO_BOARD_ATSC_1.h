...
#ifndef _BD_S6_LG_DEMO_BOARD_ATSC_1_H
#define _BD_S6_LG_DEMO_BOARD_ATSC_1_H
...
//------Extra------------------------------------------------
#define LGE_DEMO_BOARD   //If you are using LGE's demo board, you need to unmark "LGE_DEMO_BOARD" define
#if defined(LGE_DEMO_BOARD)
#define LGE_BOARD 1

/*------------------------------------Temp define here for LGE--------------------------------------*/
...
#endif // _BD_S6_LG_DEMO_BOARD_ATSC_1_H
