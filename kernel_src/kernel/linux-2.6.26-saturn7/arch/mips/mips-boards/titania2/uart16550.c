...
#else
    // 12Mhz XTAL
	*(volatile uint32*)(0xbf800000+(0x3c8c)) = 0x0000;		// use XTAL
	*(volatile uint32*)(0xbf800000+(0x3c78)) = 0x0100;		// 12MHZ
	*(volatile uint32*)(0xbf800000+(0x3c8c)) |= 0x0004;		// 12MHZ (uart_4)
#endif

    *(volatile uint32*)(0xbf800000+(0x0F55*4)) &= ~0xFF;
    *(volatile uint32*)(0xbf800000+(0x0F55*4)) |= 0x14;

#if 1//def DEFAULT_UART_RS232
